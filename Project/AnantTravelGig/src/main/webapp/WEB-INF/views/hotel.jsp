  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">        
        <div class="col">
        	<input class="form-control" type="hidden" id="modal_hotelId"/>
        	First Name: <input  class="form-control" type="text" id="modal_firstName"/>
        	Last Name: <input  class="form-control" type="text" id="modal_lastName"/>
        	Guest Age: <input class="form-control" type="number" id="modal_guestAge"/>
        	Gender: <input  class="form-control" type="text" id="modal_gender"/>
        	
        	<input style="margin-top:25px" class="btn btn-saveGuestDetails form-control btn-primary" type="button" id="" value="SAVE"/>       	
        </div>
